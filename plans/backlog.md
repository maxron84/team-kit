...
seit `BL-136` rot). Seither abgetragen: `BL-144`, `BL-142`, `BL-143`, `BL-129`, `BL-140`. Die Reihenfolge
...
still, ohne Meldung. `BL-140` ist abgetragen; die Nummern stimmen wieder. **Die Kostenkette** (`BL-141`–`BL-143`, in
