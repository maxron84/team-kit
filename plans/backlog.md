...
> dieselbe gemeldete DATEI*). Alle drei brauchen PowerShell 7 auf demselben Wirt;
> auf dieser Maschine ist `pwsh` nicht installiert. Steht hier und nicht im
