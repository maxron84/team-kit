...
def _quellen():
    ...
    Rollen-Briefings liegen im Kit unter geteilt/prompts, im Projekt
    unter team/prompts.
    """
    paare = [
        ("Beutebuch-Vorlage",
        ...
        ("Briefing Harry", ["geteilt/prompts/rolle-harry.md",
                            "team/prompts/rolle-harry.md"]),
        ("Briefing Marv", ["geteilt/prompts/rolle-marv.md",
                           "team/prompts/rolle-marv.md"]),
    ]
    gefunden = []
