...
def _quelle(*kandidaten):
    """Kit-Ablage (bash/, pwsh/) oder installierte Ablage (Wurzel)."""
...
# ------------------------------------------------------------- die Pruefobjekte
ROLLEN = [
    ("redteam", ("bash/redteam.sh", "team/redteam.sh", "team/redteam.sh"),
     ("pwsh/redteam.ps1", "team/redteam.ps1", "team/redteam.ps1"), 25),
    ("ralph", ("bash/entry/ralph.sh", "ralph.sh"),
     ("pwsh/entry/ralph.ps1", "ralph.ps1"), 8),
    ("frank", ("bash/entry/frank.sh", "frank.sh"),
     ("pwsh/entry/frank.ps1", "frank.ps1"), 15),
    ("axel", ("bash/entry/axel.sh", "axel.sh"),
     ("pwsh/entry/axel.ps1", "axel.ps1"), 12),
]

PROSA = [
    ("redteam", ("bash/redteam.sh", "team/redteam.sh",), ("pwsh/redteam.ps1", "team/redteam.ps1",), "SCOPE_LINE", "scopeLine"),
...
def test_der_vergleich_wuerde_drift_wirklich_melden():
    ...
    """
    sh = _quelle("bash/entry/frank.sh", "frank.sh")
    ps = _quelle("pwsh/entry/frank.ps1", "frank.ps1")
    if sh is None or ps is None:
