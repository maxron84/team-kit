...
Ein Befehl, ein kurzes Aufnahme-Interview, danach liegen 134 Dateien im
...
├── tests/              82 Testdateien, 572 Fälle — der Doppelbahn-Harnisch
...
- **Selbstverifikation**: `bash bash/kit-test.sh` installiert das Kit in ein
  Wegwerf-Repo und fährt dort die 572 Tests — **zweimal**: einmal mit den
...
**auch für die 134 Dateien, die der Installer im Zielprojekt hinterlässt** — sie
