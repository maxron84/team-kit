...
Ein Befehl, ein kurzes Aufnahme-Interview, danach liegen 125 Dateien im
...
├── tests/              73 Testdateien, 507 Fälle — der Doppelbahn-Harnisch
...
- **Selbstverifikation**: `bash bash/kit-test.sh` installiert das Kit in ein
  Wegwerf-Repo und fährt dort die 507 Tests — **zweimal**: einmal mit den
...
**auch für die 125 Dateien, die der Installer im Zielprojekt hinterlässt** — sie
