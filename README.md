...
Ein Befehl, ein kurzes Aufnahme-Interview, danach liegen 120 Dateien im
...
├── tests/              68 Testdateien, 482 Fälle — der Doppelbahn-Harnisch
...
- **Selbstverifikation**: `bash bash/kit-test.sh` installiert das Kit in ein
  Wegwerf-Repo und fährt dort die 482 Tests — **zweimal**: einmal mit den
...
**auch für die 120 Dateien, die der Installer im Zielprojekt hinterlässt** — sie
