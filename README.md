...
[![Regressionstests 1166](https://img.shields.io/badge/Regressionstests-1166-2ea44f?style=flat-square&logo=pytest&logoColor=white)](geteilt/tests)
...
Ein Befehl, ein kurzes Aufnahme-Interview, danach liegen 183 Dateien im
...
`TEAM.md` und 1166 Regressionstests.
...
[plans/backlog-archiv.md](plans/backlog-archiv.md) (145 Einträge).
...
kommen die Backlog-Einträge `BL-1`…`BL-222`; was davon behoben ist, steht im
[CHANGELOG](CHANGELOG.md) und in
[plans/backlog-archiv.md](plans/backlog-archiv.md) (145 Einträge), der Rest in
...
├── tests/              127 Testdateien, 1166 Fälle — der Doppelbahn-Harnisch
...
`BL-222` sind fast alle so entstanden. Damit das nicht von der Disziplin
...
- **Im Feld gelaufen, aber schmal aufgestellt.** Der Dauerbetrieb liegt bei
  **einem** Projekt (`Feld A`: 33 Kaskaden, Greenfield, Linux, bash-Bahn);
  ...
  `BL-1`…`BL-222`, von der toten Fixphase über zwei Löcher in der
...
- **Selbstverifikation**: `bash bash/kit-test.sh` installiert das Kit in ein
  Wegwerf-Repo und fährt dort die 1166 Tests — **zweimal**: einmal mit den
...
**auch für die 183 Dateien, die der Installer im Zielprojekt hinterlässt** — sie
