...
Ein Befehl, ein kurzes Aufnahme-Interview, danach liegen 133 Dateien im
...
├── tests/              81 Testdateien, 569 Fälle — der Doppelbahn-Harnisch
...
- **Selbstverifikation**: `bash bash/kit-test.sh` installiert das Kit in ein
  Wegwerf-Repo und fährt dort die 569 Tests — **zweimal**: einmal mit den
...
**auch für die 133 Dateien, die der Installer im Zielprojekt hinterlässt** — sie
