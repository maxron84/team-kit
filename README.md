...
Ein Befehl, ein kurzes Aufnahme-Interview, danach liegen 119 Dateien im
...
├── tests/              67 Testdateien, 480 Fälle — der Doppelbahn-Harnisch
...
- **Selbstverifikation**: `bash bash/kit-test.sh` installiert das Kit in ein
  Wegwerf-Repo und fährt dort die 480 Tests — **zweimal**: einmal mit den
...
**auch für die 119 Dateien, die der Installer im Zielprojekt hinterlässt** — sie
