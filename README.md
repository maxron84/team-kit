...
[![Regressionstests 650](https://img.shields.io/badge/Regressionstests-650-2ea44f?style=flat-square&logo=pytest&logoColor=white)](geteilt/tests)
...
Ein Befehl, ein kurzes Aufnahme-Interview, danach liegen 140 Dateien im
...
`TEAM.md` und 650 Regressionstests.
...
├── tests/              88 Testdateien, 650 Fälle — der Doppelbahn-Harnisch
...
- **Selbstverifikation**: `bash bash/kit-test.sh` installiert das Kit in ein
  Wegwerf-Repo und fährt dort die 650 Tests — **zweimal**: einmal mit den
...
**auch für die 140 Dateien, die der Installer im Zielprojekt hinterlässt** — sie
