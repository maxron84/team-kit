...
Ein Befehl, ein kurzes Aufnahme-Interview, danach liegen 135 Dateien im
...
├── tests/              83 Testdateien, 575 Fälle — der Doppelbahn-Harnisch
...
- **Selbstverifikation**: `bash bash/kit-test.sh` installiert das Kit in ein
  Wegwerf-Repo und fährt dort die 575 Tests — **zweimal**: einmal mit den
...
**auch für die 135 Dateien, die der Installer im Zielprojekt hinterlässt** — sie
