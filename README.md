...
Ein Befehl, ein kurzes Aufnahme-Interview, danach liegen 123 Dateien im
...
├── tests/              71 Testdateien, 494 Fälle — der Doppelbahn-Harnisch
...
- **Selbstverifikation**: `bash bash/kit-test.sh` installiert das Kit in ein
  Wegwerf-Repo und fährt dort die 494 Tests — **zweimal**: einmal mit den
...
**auch für die 123 Dateien, die der Installer im Zielprojekt hinterlässt** — sie
