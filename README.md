...
[![Regressionstests 1178](https://img.shields.io/badge/Regressionstests-1178-2ea44f?style=flat-square&logo=pytest&logoColor=white)](geteilt/tests)
...
Ein Befehl, ein kurzes Aufnahme-Interview, danach liegen 184 Dateien im
...
`TEAM.md` und 1178 Regressionstests.
...
[plans/backlog-archiv.md](plans/backlog-archiv.md) (147 Einträge).
...
[plans/backlog-archiv.md](plans/backlog-archiv.md) (147 Einträge), der Rest in
...
├── tests/              128 Testdateien, 1178 Fälle — der Doppelbahn-Harnisch
...
- **Selbstverifikation**: `bash bash/kit-test.sh` installiert das Kit in ein
  Wegwerf-Repo und fährt dort die 1178 Tests — **zweimal**: einmal mit den
...
**auch für die 184 Dateien, die der Installer im Zielprojekt hinterlässt** — sie
