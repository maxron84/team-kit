...
[![Regressionstests 1187](https://img.shields.io/badge/Regressionstests-1187-2ea44f?style=flat-square&logo=pytest&logoColor=white)](geteilt/tests)
...
Ein Befehl, ein kurzes Aufnahme-Interview, danach liegen 185 Dateien im
...
`TEAM.md` und 1187 Regressionstests.
...
[plans/backlog-archiv.md](plans/backlog-archiv.md) (150 Einträge).
...
[plans/backlog-archiv.md](plans/backlog-archiv.md) (150 Einträge), der Rest in
...
├── tests/              129 Testdateien, 1187 Fälle — der Doppelbahn-Harnisch
...
- **Selbstverifikation**: `bash bash/kit-test.sh` installiert das Kit in ein
  Wegwerf-Repo und fährt dort die 1187 Tests — **zweimal**: einmal mit den
...
**auch für die 185 Dateien, die der Installer im Zielprojekt hinterlässt** — sie
