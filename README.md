...
[![Regressionstests 1315](https://img.shields.io/badge/Regressionstests-1315-2ea44f?style=flat-square&logo=pytest&logoColor=white)](geteilt/tests)
...
Ein Befehl, ein kurzes Aufnahme-Interview, danach liegen 195 Dateien im
...
`TEAM.md` und 1315 Regressionstests.
...
├── tests/              139 Testdateien, 1315 Fälle — der Doppelbahn-Harnisch
...
- **Das Kit spricht Deutsch — eine englische Fassung ist geplant, nicht
  ...
  **wörtlich**, `zitat_lint.py` prüft Zitate, und 1315 Regressionstests
...
- **Selbstverifikation**: `bash bash/kit-test.sh` installiert das Kit in ein
  Wegwerf-Repo und fährt dort die 1315 Tests — **zweimal**: einmal mit den
...
**auch für die 195 Dateien, die der Installer im Zielprojekt hinterlässt** — sie
