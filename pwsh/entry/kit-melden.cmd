@echo off
rem Bahn: pwsh | Gegenstueck: kit-melden.sh
rem T.E.A.M. - Aufrufer fuer kit-melden.ps1. Kein Symlink: der braucht unter
...
rem im PATH dieser cmd-Sitzung, meldete diese Datei sonst nur
rem "'pwsh' is not recognized as an internal or external command" - eine
rem Meldung ueber cmd, nicht ueber das Kit.
setlocal
set "TEAM_PWSH="
...
"%TEAM_PWSH%" -NoProfile -File "%~dp0kit-melden.ps1" %*
exit /b %ERRORLEVEL%
